...
%
% COEFFICIENTS = PCA_COEFF(CUTOFF, MAX_COEFF, VARARGIN)
%
% Run PCA with standard arguments VARARGIN and return the principal component
...
%
% INPUT:
% VARARGIN      See pca() for more information on input parameters
