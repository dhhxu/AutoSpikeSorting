...
% The purpose of this script is to provide a base platform to make using and
...
% Loads path, requisite for external scripts. Fill in your TANK name and BLOCK
% number here.
...
% Functions should be in the form:
%
